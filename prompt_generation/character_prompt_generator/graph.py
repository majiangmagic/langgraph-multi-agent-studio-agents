...
from app.agents.prompt_generation.character_prompt_generator.spec import AGENT_DEFINITION, CHARACTER_PROMPT_GENERATOR_AGENT_NAME
from app.agents.registry import agent_registry


def create_graph():
    """Create the character_prompt_generator agent graph."""
