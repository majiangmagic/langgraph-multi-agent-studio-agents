...
def build_worker_prompt() -> str:
    ...
    return "\n".join(
        [
            ...
            "Read the root ARCHITECTURE.md and the ARCHITECTURE.md of every affected module before changing that module.",
            ...
            "Maintain the root or affected module ARCHITECTURE.md whenever the implementation changes architecture, module responsibilities, dependencies, data flow, or important constraints.",
